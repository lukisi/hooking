...
namespace SystemPeer
{
    ...
    public class ArgBeginEnter : Object, Json.Serializable
    {
    ...
    public class ArgCompletedEnter : Object, Json.Serializable
    {
    ...
    public class ArgAbortEnter : Object, Json.Serializable
    {
